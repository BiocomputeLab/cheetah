...
seg_train = ch.Segmenter(img_height=256, img_width=256, input_chn=1, n_classes=3)
...
seg_train.save('./output/bacteria_model.json', './output/bacteria_model_weights.h5')
