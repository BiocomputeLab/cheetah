...
ch.plot_segmask(predicted_labels[0], y_true=single_label_set[0], class_to_plot=3, xtick_int=100,
...
ch.plot_predprob(predicted_labels[0], class_names=['cell alive', 'cell dead', 'cell border', 'background'], n_classes=3, xtick_int=100,
                  ytick_int=100, show_plt=False, save_imag=True,
